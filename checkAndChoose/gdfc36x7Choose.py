...
filename = "./zip/gdfc36x7_20231007.csv"  # 替换为你的CSV文件名
...
checkMap={0: {'9': 0, '10': 0, '11': 0}, 1: {'noNum': 1}, 2: {'1': 1, '2': 1, '3': 3, '7': 1, '11': 2}, 3: {'2': 4, '6': 3, '9': 3}, 4: {'2': 6, '4': 6, '6': 5}, 5: {'5': 6, '8': 5, '9': 6}, 6: {'11': 6}}
# 统计数字出现的次数
groups = []
